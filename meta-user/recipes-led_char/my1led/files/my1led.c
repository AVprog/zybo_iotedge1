...
/// to add to /dev 
/// cat /proc/devices
// mknod /dev/pwm4motor c 245 0
// echo 50505050 > /dev/pwm4motor
//////////////////////////////////////////
...
void setValueToAllLed(unsigned char v0,unsigned char v1,unsigned char v2,unsigned char v3)
{
	printk("LED ON!!!!!!!!!!!!!!!!!!!!!!!!1");
...
EXPORT_SYMBOL(setValueToAllLed);
...
static int my1char_probeled(struct platform_device *pdev)
{
...
static struct platform_driver my1char_driver = {
    ...
    .probe      = my1char_probeled,
    .remove     = my1char_remove,
};

static int __init my1char_init(void)
{
    printk("init my1led nnnnnnnn\n");    
   // int devnum=register_chrdev(0,"my1led",&fops);
...
static void __exit my1char_exit(void)
{
    ...
    printk(KERN_ALERT "Goodbye my1led.\n");
}
